...
const FileUpload: React.FC = () => {
  ...
  const { handleCsvUpload, isUploading, uploadError } = useCsvUpload();
  ...
  return (
    <div className="mb-6">
      ...
      <div className="mt-2 text-xs text-gray-500">
        Upload a CSV file with product data. The file should include columns for name, description, category, supplier, price, unit, and available.
      </div>
    </div>
  );
};
